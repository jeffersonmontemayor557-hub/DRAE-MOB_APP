/**
 * Emergency hotline poster (Guides → Emergency Hotlines + PNG export).
 * Stored in Supabase `hotline_poster_config` for admin editing.
 */
...
/** Official CDRRMO defaults (City of Dasmariñas). */
